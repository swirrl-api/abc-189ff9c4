...
# =======================================================
NOTEBOOK_URL=http://192.168.99.254/swirrl/jupyter/dd13288b-71ca-46a3-a934-912b4f0fe71d
SERVICE_ID=dd13288b-71ca-46a3-a934-912b4f0fe71d
get_notebook http://192.168.99.254/swirrl-api/v1.0/notebook 4969e04a-17f1-4639-ae32-3e4baf0a2653 dd13288b-71ca-46a3-a934-912b4f0fe71d
echo 'Nothing to download from data staging directory.'
download_working_dir_data ${NOTEBOOK_URL}/api/contents
delete_notebook http://192.168.99.254/swirrl-api/v1.0/notebook
